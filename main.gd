...
@export var current_timer_idx = 0 : set = set_timer_idx

@onready var timer = %Timer
@onready var progress = %Progress
@onready var label = %TextLabel
@onready var time_remaining = %TimerText
@onready var audio = %Audio
@onready var popup = %Window
@onready var reward = %Reward
@onready var add_timer = %AddTimer

var current_timer:Dictionary
var styles:StyleBoxFlat
var rewards:Array = []

var local_path = OS.get_executable_path().get_base_dir()
var rewards_folder_name = "/rewards/"
